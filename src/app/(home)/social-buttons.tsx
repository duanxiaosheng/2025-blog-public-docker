...
function isSocialButtonImagePath(value: string) {
	return value.startsWith('/images/social-buttons/') || value.startsWith('/api/images/social-buttons/')
}
...
export default function SocialButtons() {
	...
	const renderButton = (button: SocialButtonConfig) => {
		...
		if (button.type === 'email' || button.type === 'wechat' || button.type === 'qq') {
			...
			const isImagePath = isSocialButtonImagePath(button.value)
